package io.github.mangomaner.mangobot.web_controller.bot_connect;
...
public class BotConnectController {
    @Resource
    private ConnectionSessionManager connectionSessionManager;
    @Resource
    ...
    public BaseResponse<List<LoginInfo>> getConnectedBots() {
        List<Long> bots = connectionSessionManager.getAllSelfIds();
